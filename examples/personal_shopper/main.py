...
import database
from langgraph_swarm import Agent, tool, Swarm
...
def notify_customer(user_id, method):
    ...
    Args:
        user_id (str): The user ID of the customer to notify.
        method (str): The preferred method of notification, either "email" or "phone".
    """
...
def order_item(user_id, product_id):
    ...
    Args:
        user_id (str): The user ID of the customer placing the order.
